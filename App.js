...
export default function App() {
  ...
  if(!ready) return <View style={styles.loCo}><ActivityIndicator size="large" color="#FFD700"/><Text style={styles.loTe}>SBA Accounts Loading...</Text></View>;
...
const styles = StyleSheet.create({
  ...
  loCo: { flex: 1, backgroundColor: '#0A192F', justifyContent: 'center', alignItems: 'center' },
  loTe: { color: '#fff', marginTop: 10 },
