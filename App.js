...
export default function App() {
  ...
  const scan = async (type) => {
    ...
    try {
      ...
      setVend(txt.split('\n')[0]?.substring(0,25) || ''); setAmt(bA.split('.')[0]);
