...
export default function App() {
  ...
  if(!r) return <View style={styles.lC}><ActivityIndicator size="large" color="#FFD700"/><Text style={styles.lT}>Loading Systems...</Text></View>;
