...
export default function App() {
  ...
  const scan = async () => {
    ...
    try {
      ...
      const bA = ns ? String(Math.max(...nums.map(n=>parseFloat(n.replace(/,/g,''))).filter(n=>n>5))) : "";
